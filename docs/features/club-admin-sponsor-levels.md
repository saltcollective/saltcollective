...
1. A Club Admin can create a new tier with a name
2. A Club Admin can rename any existing tier
...
| Question | Answer |
|----------|--------|
| Is there a default set of tiers created for new clubs, or do they start with none? | |
